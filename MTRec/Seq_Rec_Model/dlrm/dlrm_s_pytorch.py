...
class MHA(torch.nn.Module):
	def __init__(
		...
		#print("Interaction : ", self.arch_interaction_op)
		self.mha_heads = mha_heads
		#print("mha_heads : ", self.mha_heads)
...
class DLRM_Net(nn.Module):
	...
	def interact_features(self, x, ly):
		if self.arch_interaction_op == "dot":
			...
			# Debug code for getting similarity matrix
			#softmax = nn.Softmax(dim=2)
			#sim_matrix = softmax(Z)
			#sim_output = sim_matrix[:, li, lj]
			#print(sim_output)
...
if __name__ == "__main__":
	...
	parser.add_argument(
		"--arch-interaction-op", type=str, choices=['dot', 'cat', 'dcn', 'proj'], default="dot")
