...
class CriteoDataset(Dataset):
    ...
    def __init__(
        ...
        #print("self.d_path : ", self.d_path)
        self.d_file = lstr[-1].split(".")[0] if dataset == "kaggle" else lstr[-1]
        #print("self.d_file : ", self.d_file)
        ...
        #print("self.npzfile : ", self.npzfile)
        ...
        #print("self.offset_per_file : ",self.offset_per_file)
        ...
        if memory_map:
            ...
            if split == "none":
                ...
                if randomize == "day":  # or randomize == "total":
                    print("Randomizing train day data")
...
def collate_wrapper_criteo(list_of_tuples):
    ...
    '''
    print("X_int", transposed_data[0])
    print("X_cat", transposed_data[1])
    print("T", transposed_data[2])
    '''
    ...
    #lS_o = [torch.tensor(np.arange(featureCnt)) for _ in range(featureCnt)]
...
def load_test_data_and_loaders(args):
...
def load_criteo_preprocessed_data_and_loaders(args, train_hot, train_normal):
...
def load_synthetic_preprocessed_data_and_loaders(args, train_data):
